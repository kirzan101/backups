...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/settings">Membership Type</a></li>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="POST" action="/settings" onsubmit="setFormSubmitting()">
                {{ csrf_field() }}
                <br>
                <div class="form-row">
                    <div class="form-group required col-md-4">
                        <label class="control-label" for="type">Membership Type Name</label>
                        <input type="text" class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}" id="type" name="type" value="" placeholder="Type">
                        @if ($errors->has('type'))
